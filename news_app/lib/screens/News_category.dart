...
import 'package:newsapp/Category_page_helper/GetCategoryNews.dart';
...
class BusinessCategory extends StatefulWidget {
  ...
  BusinessCategory(this.name);

  @override
  _BusinessCategoryState createState() => _BusinessCategoryState(name);
}
...
class _BusinessCategoryState extends State<BusinessCategory> {
  ...
  _BusinessCategoryState(this.name);
